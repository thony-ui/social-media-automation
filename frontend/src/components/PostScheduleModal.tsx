...
export default function PostScheduleModal({
  ...
  const isCurrentlyScheduled = post?.status === 'scheduled' && post?.scheduledAt;
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300 overflow-hidden" style={{ display: '-webkit-box', WebkitLineClamp: 3, WebkitBoxOrient: 'vertical' }}>
              {post.caption}
            </p>
            {post.hashtags && (
