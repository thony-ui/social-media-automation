...
import { Calendar, Edit, Image as ImageIcon, MoreHorizontal, Trash2 } from "lucide-react";
...
export default function PostCard({ post, onMove, onEdit, onSchedule, onUnschedule, onDelete }: PostCardProps) {
  ...
  return (
    ...
    >
      <Card 
        className={`h-[480px] w-full flex flex-col hover:shadow-lg transition-all duration-200 ${
